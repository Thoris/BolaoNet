...
{
    public class BolaoCopaMundo2026ServiceHelper : IBolaoFacadeService
    {
        #region Constants

        public const string NomeBolao = "Copa do Mundo 2026";
        ...
        public BolaoCopaMundo2026ServiceHelper(Interfaces.Services.Boloes.IApostaExtraService apostaExtraService,
        ...
        public Domain.Entities.Boloes.Bolao CreateBolao(Domain.Entities.Campeonatos.Campeonato campeonato)
        {
            ...
            Domain.Entities.Boloes.Bolao bolao = new Domain.Entities.Boloes.Bolao(NomeBolao)
            {
                ...
                DataInicio = new DateTime(2026, 6, 5),
            ...
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * O participante classificado em 1º lugar receberá o equivalente a 70% (setenta por cento) do valor total arrecadado no bolão." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * O participante classificado em 2º lugar receberá o equivalente a 20% (vinte por cento) do valor total arrecadado no bolão." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * O participante classificado em 3º lugar receberá o equivalente a 9% (nove por cento) do valor total arrecadado no bolão." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * O participante classificado na última colocação receberá o equivalente a 1% (um por cento) do valor total arrecadado no bolão." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * Em caso de empate nas posições premiadas, o valor correspondente será dividido proporcionalmente entre os participantes empatados. " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Exemplo: caso haja empate em 1º lugar entre dois participantes, cada um receberá 45% da premiação, e o participante subsequente receberá a premiação referente ao 3º lugar (9%). " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Em caso de empate em 2º lugar entre dois participantes, os 29% restantes serão divididos igualmente, resultando em 14,5% para cada participante." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Caso o participante não realize sua aposta dentro do prazo estipulado para determinado jogo, será automaticamente considerado o placar padrão de 0 x 0 para fins de pontuação." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "A taxa de participação no bolão será de R$ 50,00 (cinquenta reais) por participante." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "CRITÉRIOS DE PONTUAÇÃO:" });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * 10 PONTOS — Acerto exato do placar da partida. Exemplo: aposta 2 x 1 e resultado final 2 x 1." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * 5 PONTOS — Acerto do resultado de empate, porém com quantidade de gols divergente. Exemplo: aposta 1 x 1 e resultado final 2 x 2." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * 4 PONTOS — Acerto do time vencedor e acerto de apenas um dos placares. Exemplo: aposta 2 x 1 e resultado final 3 x 1." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * 3 PONTOS — Acerto apenas do time vencedor, sem acerto dos placares. Exemplo: aposta 2 x 1 e resultado final 1 x 0." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * 1 PONTO — Erro no resultado final da partida, porém com acerto de apenas um dos placares. Exemplos: aposta 2 x 1 e resultado final 0 x 1; ou aposta 2 x 1 e resultado final 1 x 1." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "   * 0 PONTO — Aplicável a todas as demais situações que não se enquadrem nos critérios acima." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "As partidas da Seleção Brasileira terão pontuação dobrada. Dessa forma, os critérios passarão a valer 20, 10, 8, 6 e 2 pontos, respectivamente. " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Exemplo: ao acertar exatamente o placar de uma partida do Brasil, o participante receberá 20 pontos ao invés de 10." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Os palpites referentes à classificação final dos 4 (quatro) primeiros colocados da competição terão pontuação fixa de 10 pontos para cada posição acertada corretamente." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "O sistema realizará automaticamente projeções dos confrontos da fase eliminatória com base nos palpites cadastrados pelos participantes ao longo da competição." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Para fins de pontuação na fase eliminatória, será considerado válido o resultado correspondente ao confronto oficial da competição, " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "independentemente das seleções inicialmente exibidas na projeção da aposta. Exemplo: caso a aposta apresente Brasil x Chile, mas o confronto real venha a ser Portugal x Chile, " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "a pontuação será calculada normalmente com base no resultado efetivo do jogo realizado." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Na fase eliminatória, a regra de pontuação dobrada será aplicada exclusivamente às partidas reais da Seleção Brasileira, " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "e não aos confrontos projetados automaticamente pelo sistema durante o preenchimento das apostas." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Os confrontos da fase eliminatória serão definidos com base nas posições classificatórias dos grupos. Assim, o participante estará apostando, " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "por exemplo, no 1º colocado do Grupo A contra o 2º colocado do Grupo B, independentemente das seleções efetivamente classificadas." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Em situações excepcionais envolvendo desistência, exclusão, suspensão ou substituição de seleções participantes da competição após o registro das apostas, " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "todas as apostas diretamente associadas à seleção afetada serão automaticamente consideradas como pontuação máxima de 10 pontos para os participantes. " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Exemplo: caso uma seleção como o Irã venha a desistir ou seja retirada da competição, todas as apostas vinculadas aos jogos dessa seleção receberão pontuação integral equivalente ao acerto exato do placar." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Após o encerramento do prazo oficial para realização das apostas, será encaminhado a todos os participantes um arquivo em formato PDF contendo a consolidação completa das apostas registradas por todos os participantes do bolão. " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Cada participante terá o prazo de até 24 (vinte e quatro) horas, contadas a partir do envio do arquivo, para solicitar eventuais correções, ajustes ou reportar inconsistências relacionadas às apostas registradas. " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Decorrido este prazo sem manifestação formal do participante, todas as apostas constantes no documento serão consideradas corretas, validadas e oficialmente aceitas para fins de apuração da competição." });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Ao término da competição, será encaminhado por e-mail aos participantes um novo arquivo consolidado em formato PDF contendo todas as apostas realizadas, as pontuações obtidas em cada fase e a classificação final do bolão. " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Após o envio do referido documento, os participantes terão igualmente o prazo de até 24 (vinte e quatro) horas para apresentação de eventuais questionamentos, solicitações de revisão, ajustes ou reclamações relacionadas à apuração dos resultados. " });
            StoreData<Domain.Entities.Boloes.BolaoRegra>(_bolaoRegraService, new Domain.Entities.Boloes.BolaoRegra(bolao.Nome, c++) { Descricao = "Após o término deste prazo, os resultados apresentados serão considerados definitivos, homologados e aceitos por todos os participantes." });
            #endregion
        ...
        {
            Domain.Entities.Boloes.Bolao bolao = new Domain.Entities.Boloes.Bolao("Copa do Mundo 2026");
