...
{
    public class BolaoCopaMundo2014ServiceHelper : IBolaoFacadeService
    {
        #region Constants
        ...
        public BolaoCopaMundo2014ServiceHelper(Interfaces.Services.Boloes.IApostaExtraService apostaExtraService,
        ...
        //public bool StoreData<T>(Servicelication.Base.IGenericService<T> Service, T data)
