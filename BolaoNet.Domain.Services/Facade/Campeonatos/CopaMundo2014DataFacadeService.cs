...
namespace BolaoNet.Domain.Services.Facade.Campeonatos
{
        ...
        : BaseCopaMundoFacadeService
    {
        ...
        public CopaMundo2014DataFacadeService(
            ...
            : base(timeService, campeonatoService, campeonatoTimeService, campeonatoFaseService, 
                campeonatoGrupoService, campeonatoGrupoTimeService, estadioService, jogoService,
        ...
        public bool InsertResults(Entities.Campeonatos.Campeonato campeonato)
        {
            ...
            {
                base.InsertResult(campeonato, jogoLabels[c], true, new Entities.Users.User("thoris"), time1[c], time2[c], penaltis1[c], penaltis2[c]);
            }
