...
namespace BolaoNet.Domain.Services.Boloes
{
        ...
        Interfaces.Services.Boloes.IBolaoCriterioPontosTimesService
    {
        ...
        public BolaoCriterioPontosTimesService(string userName, Interfaces.Repositories.Boloes.IBolaoCriterioPontosTimesDao dao)
            : base(userName, (Interfaces.Repositories.Base.IGenericDao<Entities.Boloes.BolaoCriterioPontosTimes>)dao)
        {
