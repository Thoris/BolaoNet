...
namespace BolaoNet.Domain.Services.Boloes
{
        ...
        Interfaces.Services.Boloes.IApostaExtraService
    {
        ...
        public ApostaExtraService(string userName, Interfaces.Repositories.Boloes.IApostaExtraDao dao)
            : base(userName, (Interfaces.Repositories.Base.IGenericDao<Entities.Boloes.ApostaExtra>)dao)
        {
