...
{
    public class PdfApostasUserReport : BasePdfManager, IApostasUserReport
    {
        #region Variables
        ...
        public PdfApostasUserReport()
        {

        }
        public PdfApostasUserReport(string imageFolder, string outputFile)
        {
        ...
        public void GenerateApostas(Entities.Boloes.Bolao bolao, Entities.Campeonatos.Campeonato campeonato, Entities.Users.User user, IList<Entities.Campeonatos.Jogo> jogos, IList<Entities.Boloes.Bolao> jogosUsuarios)
        {
            if (bolao == null)
