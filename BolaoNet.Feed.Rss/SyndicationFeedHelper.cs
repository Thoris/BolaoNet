...
namespace BolaoNet.Feed.Rss
{
    ...
    public class SyndicationFeedHelper<TFeedItem> where TFeedItem : class
    {
        ...
        private IList<TFeedItem> feedItems;
        private SyndicationFeedItemMapper<TFeedItem> feedItemMapper;
        private SyndicationFeedOptions feedOptions;
        private SyndicationFeed syndicationFeed;
        private IList<SyndicationItem> syndicationItems;
        ...
        public IList<TFeedItem> FeedItems
        {
            get
            {
        ...
        public SyndicationFeedItemMapper<TFeedItem> FeedItemMapper
        {
            get
            {
        ...
        public SyndicationFeedOptions SyndicationFeedOptions
        {
            get
            {
