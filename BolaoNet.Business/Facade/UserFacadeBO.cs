...
namespace BolaoNet.Business.Facade
{
    public class UserFacadeBO : Interfaces.Facade.IUserFacadeBO
    {
        ...
        private Interfaces.Boloes.IBolaoRequestBO _bolaoRequestBO;

        #endregion

        #region Constructors/Destructors

        public UserFacadeBO(string currentUserName, Interfaces.IFactoryBO factory)
        {
            _userBO = factory.CreateUserBO();
            _userInRoleBO = factory.CreateUserInRoleBO();
            _bolaoRequestBO = factory.CreateBolaoRequestBO();
