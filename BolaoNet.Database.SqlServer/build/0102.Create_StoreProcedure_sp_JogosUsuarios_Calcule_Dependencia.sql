...
BEGIN
	...
	DECLARE curJogosTime1 CURSOR FOR	
	 SELECT	JogoID, PendenteTime1Ganhador
	   FROM Jogos 
	  WHERE NomeCampeonato		= @NomeCampeonato
	    AND PendenteIdTime1	= @IDJogo
	...
	DECLARE curJogosTime2 CURSOR FOR	
	 SELECT	JogoID, PendenteTime2Ganhador
	   FROM Jogos 
	  WHERE NomeCampeonato		= @NomeCampeonato
	    AND PendenteIDTime2		= @IDJogo
