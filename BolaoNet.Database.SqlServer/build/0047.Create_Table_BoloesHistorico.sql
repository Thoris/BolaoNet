...
ALTER TABLE [dbo].[BoloesHistorico]  WITH CHECK ADD FOREIGN KEY([CreatedBy])
REFERENCES [dbo].[Usuarios] ([UserName])
GO

ALTER TABLE [dbo].[BoloesHistorico]  WITH CHECK ADD FOREIGN KEY([ModifiedBy])
REFERENCES [dbo].[Usuarios] ([UserName])
GO

ALTER TABLE [dbo].[BoloesHistorico]  WITH CHECK ADD FOREIGN KEY([NomeBolao])
