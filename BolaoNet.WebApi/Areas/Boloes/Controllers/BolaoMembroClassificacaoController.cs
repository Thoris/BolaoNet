...
namespace BolaoNet.Services.Areas.Boloes.Controllers
{
        ...
        Domain.Interfaces.Services.Boloes.IBolaoMembroClassificacaoService
    {
        ...
        /// </summary>
        private Domain.Interfaces.Services.Boloes.IBolaoMembroClassificacaoService Dao
        {
        ...
        public BolaoMembroClassificacaoController()
            : base(new Domain.Services.FactoryService().CreateBolaoMembroClassificacaoService())
        {
