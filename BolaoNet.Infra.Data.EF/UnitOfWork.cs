...
namespace BolaoNet.Infra.Data.EF
{
    public class UnitOfWork : DbContext, Base.IUnitOfWork
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new Mapping.Boloes.BolaoHistoricoConfiguration());
            ...
            modelBuilder.Configurations.Add(new Mapping.Boloes.BolaoMembroPontoConfiguration());
