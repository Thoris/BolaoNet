...
namespace BolaoNet.Infra.Data.EF.Base
{
 /// <summary>
    ...
    public class BaseRepositoryDao<T> : IDisposable, Domain.Interfaces.Repositories.Base.IGenericDao<T> where T : class
    {
        #region Constants
        ...
        public T Load(T entity)
        {
            try
            {
                Domain.Entities.Base.BaseEntity keyEntity = entity as Domain.Entities.Base.BaseEntity;
