...
namespace BolaoNet.Application.Reports.FormatReports.PDF.Base
{
    public class BasePdfCopaMundoReport : Reports.FormatReports.Base.BaseFileReport
    {
        #region Constructors/Destructors

        public BasePdfCopaMundoReport(string outputFile)
            : base (outputFile)
        {
        ...
        public void CreatePage(bool showOnlyPartidaValida, bool fim, int posicao, int pontos, PdfWriter writer, string imageExtension, string noPictureFile, string imageUserPath, string imageTimesPath,  Domain.Entities.Users.User user, IList<EntityJogoUsuario> list, IList<EntityApostasExtras> listExtra)
        {
        ...
        private PdfPTable CreateApostasExtras(bool fim, string imageTimesFolder, string imageExtension, IList<EntityApostasExtras> apostasExtras)
        {
            ...
            foreach (EntityApostasExtras aposta in apostasExtras)
            {
                ...
                string timeFileImage = System.IO.Path.Combine(imageTimesFolder, aposta.ApostaExtraUsuario.NomeTime + "." + imageExtension);
        ...
        private void CreateGrupos(bool showOnlyPartidaValida, bool fim, PdfWriter writer, string imagePath, string imageExtension, IList<EntityJogoUsuario>[] list)
        {
        ...
        private PdfPTable CreateGrupoJogos(bool showOnlyPartidaValida, bool fim, string imageExtension, string title, string imagePath, IList<EntityJogoUsuario> list)
        {
        ...
        private PdfPTable CreateJogoInGroupFormat(bool showOnlyPartidaValida, bool fim, string imageExtension, Color backColor, string imagePath, EntityJogoUsuario jogo)
        {
            ...
            string time1FileImage = System.IO.Path.Combine(imagePath, jogo.Jogo.NomeTime1 + "." + imageExtension);
            ...
            string time2FileImage = System.IO.Path.Combine(imagePath, jogo.Jogo.NomeTime2 + "." + imageExtension);
        ...
        private void CreateEliminatorias(bool showOnlyPartidaValida, bool fim, PdfWriter writer, string imagePath, string imageExtension, IList<EntityJogoUsuario> oitavas, IList<EntityJogoUsuario> quartas, IList<EntityJogoUsuario> semiFinais, IList<EntityJogoUsuario> finais)
        {
        ...
        private PdfPTable CreateTimeEliminatoriaFormat(bool showOnlyPartidaValida, bool fim, bool showTitle, string imageExtension, string imagePath, bool timeCasa, EntityJogoUsuario jogo)
        {
            float[] relative = null;
            ...
            PdfPCell cellImageTime = new PdfPCell();
            string timeFileImage = System.IO.Path.Combine(imagePath, (timeCasa ? jogo.JogoUsuario.NomeTimeResult1 : jogo.JogoUsuario.NomeTimeResult2) + "." + imageExtension);
            if (System.IO.File.Exists(timeFileImage))
            {
                Image imgTime = Image.GetInstance(timeFileImage);
                cellImageTime.AddElement(imgTime);
        ...
        private PdfPTable CreateJogoInEliminatoriaFormat(bool showOnlyPartidaValida, bool fim, Color backColor, bool showTitle, string imagePath, string imageExtension, EntityJogoUsuario jogo)
        {
        ...
        private PdfPTable CreateOitavasLeft(bool showOnlyPartidaValida, bool fim, string imagePath, string imageExtension, IList<EntityJogoUsuario> list)
        {
        ...
        private PdfPTable CreateQuartasLeft(bool showOnlyPartidaValida, bool fim, string imagePath, string imageExtension, IList<EntityJogoUsuario> list)
        {
            PdfPTable fase = new PdfPTable(1);
            fase.DefaultCell.Padding = 0;
            fase.DefaultCell.BorderWidth = 0;
        ...
        private PdfPTable CreateSemiFinaisLeft(bool showOnlyPartidaValida, bool fim, string imagePath, string imageExtension, IList<EntityJogoUsuario> list)
        {
            PdfPTable fase = new PdfPTable(1);
            fase.DefaultCell.Padding = 0;
            fase.DefaultCell.BorderWidth = 0;
        ...
        private PdfPTable CreateOitavasRight(bool showOnlyPartidaValida, bool fim, string imagePath, string imageExtension, IList<EntityJogoUsuario> list)
        {
            PdfPTable fase = new PdfPTable(1);
            fase.DefaultCell.Padding = 0;
            fase.DefaultCell.BorderWidth = 0;
        ...
        private PdfPTable CreateQuartasRight(bool showOnlyPartidaValida, bool fim, string imagePath, string imageExtension, IList<EntityJogoUsuario> list)
        {
            PdfPTable fase = new PdfPTable(1);
            fase.DefaultCell.Padding = 0;
            fase.DefaultCell.BorderWidth = 0;
        ...
        private PdfPTable CreateSemiFinaisRight(bool showOnlyPartidaValida, bool fim, string imagePath, string imageExtension, IList<EntityJogoUsuario> list)
        {
            PdfPTable fase = new PdfPTable(1);
            fase.DefaultCell.Padding = 0;
            fase.DefaultCell.BorderWidth = 0;
        ...
        private PdfPTable CreateFinais(bool showOnlyPartidaValida, bool fim, string imagePath, string imageExtension, IList<EntityJogoUsuario> list)
        {
            PdfPTable fase = new PdfPTable(1);
            fase.DefaultCell.Padding = 0;
            fase.DefaultCell.BorderWidth = 0;
        ...
        private EntityJogoUsuario GetJogoByLabel(int jogoId, IList<EntityJogoUsuario> list)
        {
            ...
            return new EntityJogoUsuario(new Domain.Entities.Campeonatos.Jogo(), new Domain.Entities.Boloes.JogoUsuario());
        }
